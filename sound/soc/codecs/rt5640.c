...
static void rt5640_enable_micbias1_ovcd(struct snd_soc_component *component)
{
...
static void rt5640_disable_micbias1_ovcd(struct snd_soc_component *component)
{
	struct snd_soc_dapm_context *dapm = snd_soc_component_get_dapm(component);
...
static void rt5640_jack_work(struct work_struct *work)
{
	...
	if (!rt5640_jack_inserted(component)) {
		...
		/* Jack inserted */
		rt5640_enable_micbias1_ovcd(component);
		status = rt5640_detect_headset(component);
		rt5640_disable_micbias1_ovcd(component);
